...
def main():
    ...
    decoder.load_state_dict(torch.load('/kaggle/input/adain/pytorch/main/8/decoder.pth'))
    vgg.load_state_dict(torch.load('/kaggle/input/adain/pytorch/main/8/vgg_normalised.pth'))
